        ...
        try:
            ...
            if cupon.compartido or customer in cupon.usuarios_asociados.all():
                ...
                if cupon.descuento_porcentaje is not None:
                    descuento = (total_carrito * cupon.descuento_porcentaje) / 100
                    nuevo_total = total_carrito - descuento
                ...
                # pedido.save()
                return JsonResponse({'valid': True, 'descuento': descuento, 'nuevo_total': nuevo_total})
            else:
